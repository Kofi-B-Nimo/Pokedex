...
pokemon_data = zip(poke_ids,pokemon_names,types,moves1,moves2,moves3,heights,weights)
pokemon_dict = {poke_ids:(pokemon_names,types,moves1,moves2,moves3,heights,weights) for poke_ids,pokemon_names,types,moves1,moves2,moves3,heights,weights in pokemon_data}
    
# print(pokemon_dict)

pokedex_df = pd.DataFrame(pokemon_dict )
pokedex_table = pokedex_df.transpose()

# pokedex_table = pd.DataFrame(pokedex_table, columns = ['ID', 'name', 'type', 'move 1', 'move 2', 'move 3', 'height', 'weight'])

# print(pokedex_table)
dfcolumn_names = ['name', 'type', 'move 1', 'move 2', 'move 3', 'height', 'weight' ]
pokedex_table.columns = dfcolumn_names 

pokedex_table['height'] = pokedex_table.height * 10
pokedex_table['weight'] = pokedex_table.weight / 10
pokedex_table['name'] = pokedex_table['name'].str.title()

dfcolumn_names2 = ['name', 'type', 'move 1', 'move 2', 'move 3', 'height(cm)', 'weight(kg)' ]
pokedex_table.columns = dfcolumn_names2 
